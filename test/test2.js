...
export default Ember.Component.extend({
  ...
  emComFn: Ember.computed('someObj', 'someObj1', function () {
    console.log('test2.js > emComFn :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
  ...
  emComFnLines: Ember.computed('obj1',
    'obj2',
    function(){
      console.log('test2.js > function :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
  ...
  checkIf: Ember.computed('obj1', function(){
    console.log('test2.js > checkIf :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
    const m = 1;
  ...
  checkSwitch: Ember.computed('obj1', function(){
    console.log('test2.js > checkSwitch :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
  ...
  checkWhile: Ember.computed('obj1', function(){
    console.log('test2.js > checkWhile :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
    const m = 1;
    let arr = [];
  ...
  checkFn: Ember.computed('obj1', function(){
    console.log('test2.js > checkFn :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
    const fn = function(){
      console.log('test2.js > fn :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
      return 'first :: fn';
    };

    let fn1 = function(){
      console.log('test2.js > let fn1 = function :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
      return 'second :: fn1';
    };
  ...
  actions: {
     ...
     */
    changeState(state){
      console.log('test2.js > changeState :: START'); // methodKey: [HA7WLRUUFBPDGU1HV9529]
